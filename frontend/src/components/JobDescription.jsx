...
const JobDescription = () => {
    ...
    const applyJobHandler = async () => {
        try {
            const res = await axios.get(`https://workbuddy-mp1.onrender.com/apply/${jobId}`, {withCredentials:true});
    ...
    useEffect(()=>{
        const fetchSingleJob = async () => {
            try {
                const res = await axios.get(`https://workbuddy-mp1.onrender.com/get/${jobId}`,{withCredentials:true});
                if(res.data.success){
